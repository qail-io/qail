...
- QAIL is now on the `v2.0.0` release-candidate line across the Rust workspace crates and CLI.
...
Current QAIL `2.0.0` application code should use the native AST/DSL path:
