...
mod tests {
    ...
    fn typed_bool_oid_16() {
        ...
        assert_eq!(text_to_json_typed("true", 16), serde_json::Value::Bool(true));
        assert_eq!(text_to_json_typed("f", 16), serde_json::Value::Bool(false));
        assert_eq!(text_to_json_typed("false", 16), serde_json::Value::Bool(false));
    }
    ...
    fn typed_int_oid_23() {
        ...
        assert_eq!(text_to_json_typed("not_a_number", 23), serde_json::json!("not_a_number"));
    }

    #[test]
    fn typed_bigint_oid_20() {
        assert_eq!(text_to_json_typed("9223372036854775807", 20), serde_json::json!(9223372036854775807_i64));
    }

    #[test]
    fn typed_float_oid_701() {
        assert_eq!(text_to_json_typed("3.14", 701), serde_json::json!(3.14));
    ...
    fn typed_numeric_oid_1700() {
        ...
        assert_eq!(text_to_json_typed("1e999", 1700), serde_json::json!("1e999"));
    }
    ...
    fn typed_json_oid_114() {
        ...
        assert_eq!(text_to_json_typed("not json", 114), serde_json::json!("not json"));
    }

    #[test]
    fn typed_jsonb_oid_3802() {
        assert_eq!(text_to_json_typed("[1,2,3]", 3802), serde_json::json!([1, 2, 3]));
    }
    ...
    fn typed_array_oid_1007() {
        assert_eq!(text_to_json_typed("{1,2,3}", 1007), serde_json::json!([1, 2, 3]));
    }
    ...
    #[test]
    fn guess_float() {
        assert_eq!(text_to_json_guess("3.14"), serde_json::json!(3.14));
    }
    ...
    fn guess_json_object() {
        assert_eq!(text_to_json_guess(r#"{"a":1}"#), serde_json::json!({"a": 1}));
    }
    ...
    fn guess_string_fallback() {
        assert_eq!(text_to_json_guess("hello world"), serde_json::json!("hello world"));
    }
    ...
    fn pg_array_non_array_passthrough() {
        assert_eq!(pg_array_to_json("not an array"), serde_json::json!("not an array"));
    }
