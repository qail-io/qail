...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!(
        "   ✓ Generating {} realistic points with metadata...",
        NUM_POINTS
    );
    ...
    println!("═══════════════════════════════════════════════════════════════");
    println!(
        "📊 Benchmark 1: QAIL Proto Encoding Speed ({} iterations)",
        NUM_SEARCHES
    );
    println!("───────────────────────────────────────────────────────────────");
    ...
    for vector in &query_vectors {
        encoder::encode_search_proto(&mut buffer, COLLECTION_NAME, vector, 10, None, None);
    }
    ...
    println!("═══════════════════════════════════════════════════════════════");
    println!(
        "📊 Benchmark 2: Official qdrant-client ({} iterations)",
        NUM_SEARCHES
    );
    println!("───────────────────────────────────────────────────────────────");
    ...
    println!("═══════════════════════════════════════════════════════════════");
    println!(
        "📊 Benchmark 3: QAIL gRPC Zero-Copy ({} iterations)",
        NUM_SEARCHES
    );
    println!("───────────────────────────────────────────────────────────────");
    ...
    if qail_vs_official > 1.0 {
        println!(
            "   🚀 QAIL is {:.2}x faster than official client",
            qail_vs_official
        );
    } else if qail_vs_official > 0.95 {
        println!(
            "   ≈  QAIL is comparable to official client ({:.2}x)",
            qail_vs_official
        );
    } else {
        println!(
            "   ⚠️  Official client is {:.2}x faster than QAIL",
            1.0 / qail_vs_official
        );
